...
class CallGraphAnalyzer {
    ...
    //     // Configuración con espaciado
    //     pikchr += "boxwid = 2.2\n";
    //     pikchr += "boxht = 1.0\n";
    //     pikchr += "boxgap = 0.5\n\n";
        
    //     // Generar boxes con nombres únicos
    //     var nodeCount = 0;
    ...
    //             var boxName = "Box" + nodeCount:string;
    ...
    //             // Crear el box con posición y distancias
    //             if nodeCount == 0 {
    //                 // Primer box
    //                 pikchr += boxName + ": box fill " + fillColor + " \"" + funcName + "\"\n";
    //             } else if nodeCount % nodesPerRow == 0 {
    //                 // Nueva fila - calculamos qué box usar como referencia
    //                 var rowNumber = nodeCount / nodesPerRow;
    //                 var refBox = "Box" + ((rowNumber - 1) * nodesPerRow):string;
    //                 pikchr += boxName + ": box fill " + fillColor + " \"" + funcName + "\" " +
    //                         "below " + refBox + " + (0, 3cm)\n";
    //             } else {
    //                 // Mismo fila, a la derecha con distancia
    //                 var prevBox = "Box" + (nodeCount-1):string;
    //                 pikchr += boxName + ": box fill " + fillColor + " \"" + funcName + "\" " +
    //                         "right of " + prevBox + " + (3cm, 0)\n";
    //             }
                
    //             // Añadir métricas como texto separado
    //             if complexityMetrics {
    //                 pikchr += "text \"CC:" + funcInfo.complexity.cyclomaticComplexity:string + 
    //                         " MI:" + funcInfo.complexity.maintainabilityIndex:int:string + "\" " +
    //                         "at " + boxName + ".s + (0,-0.3)\n";
    ...
    //     // Resto del código para conexiones...
    //     pikchr += "\n/* Connections */\n";
        
    //     // Generar conexiones usando nombres de boxes
    //     for caller in this.callGraph.keys() {
    //         if functionToBoxName.contains(caller) {
    //             var callees = this.callGraph[caller];
    //             for callee in callees {
    //                 if functionToBoxName.contains(callee) {
    //                     var callerBox = functionToBoxName[caller];
    //                     var calleeBox = functionToBoxName[callee];
                        
    //                     // Determinar estilo de flecha
    //                     var arrowStyle = "arrow";
    //                     if this.functions.contains(callee) {
    //                         ref calleeInfo = this.functions[callee];
    //                         if calleeInfo.isGPUKernel {
    //                             arrowStyle = "arrow thick color gold";
    ...
    //                     pikchr += arrowStyle + " from " + callerBox + " to " + calleeBox + "\n";
    //                 }
    //             }
    //         }
    //     }
    ...
    //     if complexityMetrics && nodeCount > 0 {
    //         var totalRows = (nodeCount + nodesPerRow - 1) / nodesPerRow;
    //         pikchr += "\n/* Legend */\n";
    //         pikchr += "LegendBox: box \"Legend\" at Box0.sw + (0, " + (-(totalRows + 1) * 4):string + "cm)\n";
    //         pikchr += "text \"CC: Cyclomatic Complexity\" at LegendBox.s + (0,-0.5)\n";
    //         pikchr += "text \"MI: Maintainability Index\" at LegendBox.s + (0,-1.0)\n";
    //     }
    ...
    //     // Generar boxes con posicionamiento correcto
    ...
    //             // Primer box
    //             pikchr += boxName + ": box fill " + fillColor + " \"" + funcName + "\"\n";
    //         } else if i % nodesPerRow == 0 {
    //             // Primera columna de nueva fila
    //             pikchr += boxName + ": box fill " + fillColor + " \"" + funcName + "\" below Box0 + (0, " + 
    //                     (-(i / nodesPerRow) * 4):string + "cm)\n";
    //         } else {
    //             // Misma fila, siguiente columna
    //             var prevBox = "Box" + (i-1):string;
    //             pikchr += boxName + ": box fill " + fillColor + " \"" + funcName + "\" right of " + 
    //                     prevBox + " + (3.5cm, 0)\n";
    //         }
    ...
    //         pikchr += "\n/* Legend */\n";
    //         pikchr += "Legend: box \"Legend\" at Box0.sw + (0, " + (-(totalRows + 2) * 4):string + "cm)\n";
    //         pikchr += "text \"CC: Cyclomatic Complexity\" at Legend.s + (0,-0.5)\n";
    //         pikchr += "text \"MI: Maintainability Index\" at Legend.s + (0,-1.0)\n";
    //     }
    ...
    //         // Posicionamiento correcto usando sintaxis PikChr válida
    //         if i == 0 {
    //             // Primer box
    //             pikchr += boxName + ": box fill " + fillColor + " \"" + funcName + "\"\n";
    //         } else if i % nodesPerRow == 0 {
    //             // Nueva fila - usar posición absoluta
    //             var rowOffset = (i / nodesPerRow) * 3;
    //             pikchr += boxName + ": box fill " + fillColor + " \"" + funcName + "\" " +
    //                     "at Box0 + (0, " + (-rowOffset):string + "cm)\n";
    //         } else {
    //             // Misma fila - usar posición relativa simple
    //             var prevBox = "Box" + (i-1):string;
    //             pikchr += boxName + ": box fill " + fillColor + " \"" + funcName + "\" " +
    //                     "at " + prevBox + " + (4cm, 0)\n";
    //         }
